      ...
      steps: [
        ...
        },
        {
          ...
          instructions: [
            ...
            '「Account ID」「Client ID」「Client Secret」をそれぞれコピー',
            '上の認証情報フォームに各値を入力',
          ],
        },
        {
        ...
        },
        {
          ...
          tips: ['Webhook URLはhttpsである必要があります'],
        },
        {
          id: 'zoom-5',
          title: 'イベントタイプを選択',
        ...
        },
        {
          ...
          instructions: [
            ...
            '上のフォームの「Webhook Secret Token」に入力',
          ],
          warnings: ['Secret Tokenは必ず保存してください'],
        },
        {
          id: 'zoom-7',
          title: 'アプリを有効化して接続確認',
          description: 'アプリをアクティブにして接続テストを実行します',
          instructions: [
            'Zoom側で「Activation」タブを開く',
            '「Activate your app」をクリック',
            'このページの「保存して接続テスト」ボタンをクリック',
            '「接続済み」になれば設定完了',
          ],
        },
      ],
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          warnings: ['APIキーは作成時に一度だけ表示されます'],
        },
        {
          id: 'openai-3',
          title: '接続テストを実行',
          description: 'APIキーを保存して接続を確認します',
          instructions: [
            '上のフォームの「API Key」にキーを入力',
            '「保存して接続テスト」ボタンをクリック',
            '「接続済み」になれば文字起こし・要約機能が利用可能',
          ],
        },
      ],
    },
      ...
      steps: [
        ...
        },
        {
          ...
          instructions: [
            ...
            'URLからスプレッドシートIDをコピー',
            '上のフォームの「Spreadsheet ID」に入力',
          ],
          warnings: ['シートタブ名は必ず「Sheet1」にしてください'],
        },
        {
          id: 'google-5',
          title: '接続テストを実行',
          description: '認証情報を保存して接続を確認します',
          instructions: [
            '「保存して接続テスト」ボタンをクリック',
            '「接続済み」になればYouTubeアップロード・Sheets連携が利用可能',
          ],
        },
      ],
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          instructions: [
            '作成したインテグレーションを開く',
            '「シークレット」の「Internal Integration Token」をコピー',
            '上のフォームの「API Key」に入力',
          ],
        },
        {
          id: 'notion-3',
          title: 'データベースを接続',
          description: 'データベースにインテグレーションを接続します',
          instructions: [
            'データベースページの右上「...」をクリック',
            '「接続先」→ インテグレーション名を選択',
            'URLからDatabase IDをコピー',
            '上のフォームの「Database ID」に入力',
          ],
        },
        {
          id: 'notion-4',
